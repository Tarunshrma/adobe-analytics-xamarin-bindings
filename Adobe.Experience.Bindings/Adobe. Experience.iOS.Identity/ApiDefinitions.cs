...
namespace Adobe.Experience.iOS.Identity
{
    ...
    [BaseType(typeof(NSObject))]
    interface ACPMobileVisitorId : ObjCRuntime.INativeObject
    {
    ...
    interface ACPIdentity
    {
        ...
        void GetIdentifiers(Action<NSArray<ACPMobileVisitorId>> callback);
        ...
        void GetIdentifiersWithCompletionHandler(Action<NSArray<ACPMobileVisitorId>, NSError> completionHandler);
